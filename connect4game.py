#Rows and Column for the Game Board
BOARD_COLS = 7
BOARD_ROWS = 6
...
def play():
    ...
    while not game_over:
        ...
        # Ask the user for input, only accepts valid inputs
        valid_move = False
...
if __name__ == '__main__':
    ...
    while True:
        a = input("Do you want to continue playing type yes or no : ")
        if a=="yes":
            play()
            continue
        elif a=="no":
            ...
            print("Enter either yes/no only")
